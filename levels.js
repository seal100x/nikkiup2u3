...
var extraRaw = {
	'11-1': [1.9, 1.4, 1.9, 1.4, 1.0],
	'11-2': [1.9, 2.4, 2.2, -1.5, 1.4],
	'11-3': [1.6, 1.6, -2.2, 1.8, -1],
	'11-4': [2.3, 1.1, -1.8, 1.5, -2.1],
	'11-5': [-1.9, -1.6, -1.9, -1.5, -1],
	'11-6': [1.8, -2.1, 1.2, -2, 1.7],
	'11-7': [-0.9, -2.2, -1.5, -2.1, -1.5],
	'11-8': [-1.5, 1.5, 1.8, 2.2, 0.9],
	'11-9': [1.8, 0.9, 1.9, 1.3, 1.5],
	'11-支1': [2.1, -1.3, -2, 1.4, 1],
	'11-支2': [1.6, 1.2, -1.7, 1.2, 0.7],
	'11-支3': [1.8, 2.4, 2, -1.1, 1.9],
};
 ...
 */
 var levelBonus = {
  ...
  '11-5': [addBonusInfo('B', 1, "侠客联盟")],
  '11-7': [addBonusInfo('S', 1, "欧式古典")],
 };
...
'11-1' : [['排斥中式tag']],
'11-2' : [[''],['蓝空少女, 巧克力女仆']],
'11-3' : [['需要画家上下装'],['含露低垂(充值连衣裙)']],
'11-4' : [[''], ['小满制服']],
'11-5' : [['需要女海盗上下装'],['含露低垂(充值连衣裙)']],
'11-8' : [[''],['含露低垂(充值连衣裙)']],
'11-9' : [['不能穿连衣裙'],['含露低垂(充值连衣裙)']],
};
