...
var levelsRaw = {
  ...
  '9-6-1': [1.66, -1, -1.58, 1, 1.15],
  '9-6-2': [1, -1.41, -1.53, -1, 0.8],
  '9-7': [1.42, 1.1, 1.1, -1.35, 1],
  '9-8': [1.25, 1, 1.25, 1.1, -1.1],
  '9-9-1': [-2.5, 1.1, 1.5, -1, 1],
  '9-9-2': [-2, 1.33, 1.33, -1.6, 1],
  '9-9-3': [-1.41, -1, -1.41, 1, 0.82],
  '9-支1': [1.05, 1, 1.33, 1.08, 1.3],
  '9-支2': [-1.05, -1, -1.21, 1.25, 1],
  '9-支3': [1.1, -1.45, 1.2, -1.4, 1]
};
 ...
 */
 var levelBonus = {
  ...
  '睡衣兜风派对': [addBonusInfo('S', 1, "睡衣"), addBonusInfo('SS', 1, "居家服")],
...
var addSkillsInfo = {
  ...
  '1-2': [["暖暖的微笑"]],
	...
	'9-6A': [["挑剔","灰姑娘","真爱"],["挑剔","灰姑娘","真爱"]],
	'9-6B': [["挑剔","灰姑娘"],["挑剔","灰姑娘"]],
	'9-7': [["挑剔","沉睡","反弹"],["挑剔","沉睡","反弹"]],
	'9-8': [["挑剔","沉睡","反弹"],["挑剔","沉睡","反弹"]],
	'9-9A': [["挑剔","灰姑娘","免疫"],["挑剔","灰姑娘","免疫"]],
	'9-9B': [["挑剔","沉睡","反弹"],["挑剔","沉睡","反弹"]],
	'9-9C': [["挑剔","沉睡","反弹"],["挑剔","沉睡","反弹"]],
	'9-支1': [["挑剔","沉睡","反弹"],["挑剔","沉睡","反弹"]],
	'9-支2': [["挑剔","免疫","反弹"],["挑剔","免疫","反弹"]],
	'9-支3': [["挑剔","灰姑娘","沉睡"],["挑剔","灰姑娘","沉睡"]],
  '运动饮料推广': [null,null,["挑剔","灰姑娘","礼物","微笑"]],
