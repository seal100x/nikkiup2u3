// Ivan's Workshop
var competitionsRaw = {
  '精灵的月下舞会1': [-1.2, -1.1, -1.8, 1.2, -0.9],
  '精灵的月下舞会2': [-1.1, -1.2, -1.7, -1.5, 1.3],
  '精灵的月下舞会3': [-1.5, -1.7, -1.2, -1.1, 1.0],
  '精灵的月下舞会4': [1.2, 1.2, 1.7, 1.3, 0.9],
  '精灵的月下舞会5': [1.3, -1.0, -1.5, 1.7, 1.1],
...
'10-1':[-1.00 ,1.00 ,1.33 ,1.22 ,-1.22],
'10-2':[3.00 ,-2.00 ,-2.00 ,1.00 ,-2.00],
'10-3':[1.40 ,1.00 ,1.44 ,1.10 ,1.05],
'10-4':[1.02 ,-0.98 ,-1.65 ,-1.41 ,-2.80],
'10-5':[1.22 ,-0.99 ,-1.38 ,-1.03 ,1.09],
'10-6':[-1.22 ,1.36 ,1.36 ,-1.00 ,1.08],
'10-7':[-1.35 ,1.23 ,1.00 ,1.33 ,-1.19],
